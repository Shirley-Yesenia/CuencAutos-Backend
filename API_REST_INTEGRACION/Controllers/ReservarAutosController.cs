...
namespace API_REST_INTEGRACION.Controllers
{
    ...
    public class ReservarAutosController : ApiController
    {
        private readonly IntegracionAutosLogica _ln = new IntegracionAutosLogica();

        // ============================================================
        // 🔸 POST: /api/v1/integracion/autos/book
        // ============================================================
        [HttpPost]
        [Route("api/v1/integracion/autos/book")]
        public IHttpActionResult Post([FromBody] ReservaIntegracionDto dto)
        {
            try
            {
                // Validaciones
                ...
                using (var db = new db31808Entities1())
                {
                    ...
                    // 🔗 Agregar HATEOAS
                    var hateoas = new IntegracionAutosHateoas(Url, reserva.id_reserva, dto.id_hold, dto.id_auto);
